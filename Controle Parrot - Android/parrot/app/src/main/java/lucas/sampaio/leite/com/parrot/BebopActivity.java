...
public class BebopActivity extends AppCompatActivity {
    ...
    private void initIHM() {
        ...
        startBtn1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
//                final int tempoDeExecucao = 2500;

                new Handler().post(new Runnable() {
                    @Override
                    public void run() {

                        moveLeft(Integer.parseInt(input.getText().toString()));
                        moveForward(Integer.parseInt(input.getText().toString()));
                        moveRight(Integer.parseInt(input.getText().toString()));
                        moveBack(Integer.parseInt(input.getText().toString()));
